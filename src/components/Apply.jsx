        ...
        <>
            <div className="font-face-gm">
                ...
                <div className="container apply-box">
                    <h2>JOIN THE R.E.D INITIATIVE</h2>
                    <p>
                ...
                <div className="faq-box">
                    <div className="container">
                        ...
                        <div>
                            <h2>When will I hear back once I apply?</h2>
                            <p>
                                Lorem ipsum dolor sit mag amet, consectetur emanate 
                                adipiscing elit, sed donitedh eiusmod tempor suitedad 
                                incididunt ut labore et dolor magna aliqua. Ut enim ad 
                                minim veniam, Duis aute irure dolor in reprehenderit volupt. 
                                Lorem ipsum dolor.
                            </p>
                        </div>
                        <div>
