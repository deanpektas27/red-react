      ...
      <div className="font-face-gm">
        <div className="main-headline">
          <div className="container p-5">
            ...
            <p className="mb-0">
              The Academy inspires students to aim for and achieve higher
              ambitions, empowering them to thrive in their personal and
              professional lives.
            </p>
          </div>
        </div>
        <div className="body-content program-content pb-3">
          <div className="container">
            <h2 className="body-headline font-face-gm pt-5 pb-3">
            ...
            <div className="row">
              <div className="col-lg-6">
                <div className="body-text">
                  <h1>3. RUN PHASE</h1>
                  <p className="pt-3">
                    Candidates will learn technical-based skills such as Excel
                    and PowerPoint, and gain insights into different career
                    paths in financial services.
                  </p>
                </div>
              </div>
              <div className="col-lg-6">
                <div className="body-text">
                  <h1>4. GRADUATION</h1>
                  <p className="pt-3">
                    Upon passing the three phases, Candidates will graduate to
                    become RED Leaders.
                  </p>
                </div>
              </div>
